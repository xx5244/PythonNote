...
```
  ...
  | 方法                                                 | 功能                                                                     |
  | :--------------------------------------------------- | :----------------------------------------------------------------------- |
  | str.startswith(prefix[, start[, end]])<br /> -> bool | prefix:想找的文字<br />start:起始位置<br />end:結束位置(該位置不包含)    |
  | str.endswith(suffix[, start[, end]])<br /> -> bool   | suffix:想找的文字   <br />start:起始位置<br />end:結束位置(該位置不包含) |
